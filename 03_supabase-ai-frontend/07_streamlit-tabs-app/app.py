...
from tab_pages.product_sealect import product_sealect
...
product_sealect_tab, product_create_tab, chat_tab = st.tabs(
    ["product sealect", "Product Create", "Chat"]
)
with product_sealect_tab:
    product_sealect()
